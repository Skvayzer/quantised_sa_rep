...
singularity exec instance://ml_env11 /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr-mirror' --task 'VQ-SA (SA based) clevr mirror 22.02.2023 (ckpt)' --pretrained --sa_state_dict '/home/quantised_sa/sa_autoencoder_end_to_end/clevr-mirror/VQ-SA (SA based) clevr mirror 16.02.2023 (ckpt)/89_0.015625_VQ-SA (SA based) clevr mirror 16.02.2023 (ckpt)_clevr-mirror_od_pretrained.ckpt' --beta 0.015625 --device 'gpu' --max_epochs 2000 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr-mirror" --seed 19 --nums 8 3 2 2 --num_workers 4;
      free -m;
";
