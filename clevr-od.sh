...
singularity exec instance://ml_env1 /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr' --task 'all_categorical' --beta 2 --device 'gpu' --max_epochs 2000 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr" --val_path "/home/quantised_sa/datasets/clevr_with_masks/clevr_with_masks" --seed 73 --nums 8 3 2 2 15 15 15 --num_workers 4;
      free -m;
";
