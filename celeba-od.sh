#!/bin/bash -l
#SBATCH --job-name=quantised_sa_od_celeba_40_grouped_hair_end_to_end
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'celeba' --task 'celeba_end_to_end' --device 'gpu' --max_epochs 1000 --batch_size 64 --train_path "/home/quantised_sa/datasets/celeba" --seed 0 --nums 5 3 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2  --num_workers 4;
      free -m;
";
