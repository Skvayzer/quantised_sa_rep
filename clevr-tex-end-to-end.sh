#!/bin/bash -l
#SBATCH --job-name=sa_od_clevr_tex_end_to_end
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr-tex' --task '60_4_3_end_to_end' --no-quantization --device 'gpu' --max_epochs 2000 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr-tex" --seed 1 --nums 60 4 3 --num_workers 4;
      free -m;
";
