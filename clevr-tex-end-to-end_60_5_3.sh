...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr-tex' --task 'end_to_end' --device 'gpu' --max_epochs 2000 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr-tex" --seed 0 --nums 60 5 3 --num_workers 4;
      free -m;
";
