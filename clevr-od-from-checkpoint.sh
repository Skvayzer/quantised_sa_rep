...
singularity exec instance://ml_env7 /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr' --from_checkpoint '/home/quantised_sa/sa_autoencoder_end_to_end/clevr/clevr from SA 15:51 03.02.2023/470_1.0_clevr from SA 15:51 03.02.2023_clevr_od_pretrained.ckpt' --task 'clevr VQ-SA from SA 16:35 06.02.2023 (ckpt)' --beta 1 --device 'gpu' --max_epochs 2000 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr" --val_path "/home/quantised_sa/datasets/clevr_with_masks/clevr_with_masks" --seed 31 --nums 8 3 2 2 --num_workers 4;
      free -m;
";
