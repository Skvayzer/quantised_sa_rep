...
singularity exec instance://ml_env7 /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr' --pretrained --sa_state_dict '/home/quantised_sa/sa_autoencoder_end_to_end/clevr/clevr from SA 24.02.2023/545_0.015625_clevr from SA 24.02.2023_clevr_od_pretrained.ckpt' --task 'clevr VQ-SA from SA 05.03.2023 (ckpt)' --beta 0.015625 --device 'gpu' --max_epochs 2000 --batch_size 48 --train_path "/home/quantised_sa/datasets/sa_clevr/clevr_with_masks_6" --seed 31 --nums 8 3 2 2 --num_workers 4;
      free -m;
" > output.txt;
