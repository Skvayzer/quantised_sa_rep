...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'clevr-tex' --task 'clevr-tex_end_to_end' --from_checkpoint './sa_autoencoder_end_to_end/90_2.0_sa_od_pretrained.ckpt' --device 'gpu' --max_epochs 442 --batch_size 64 --train_path "/home/quantised_sa/datasets/clevr-tex" --seed 0 --nums 8 8 8 8 --num_workers 4;
      free -m;
";
