...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'tetrominoes' --task 'tetrominoes_end_to_end' --device 'gpu' --max_epochs 1000 --batch_size 64 --train_path "/home/quantised_sa/datasets/multi_objects/tetrominoes" --seed 0 --nums 17 6 2 --num_workers 4;
      free -m;
";
