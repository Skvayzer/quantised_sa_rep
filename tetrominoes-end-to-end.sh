#!/bin/bash -l
#SBATCH --job-name=quantised_sa_od_tetrominoes_scale_-1to1_end_to_end
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity exec instance://ml_env /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/training_od.py --dataset 'tetrominoes' --task 'tetrominoes scale[-1;1]' --device 'gpu' --max_epochs 1000 --batch_size 64 --train_path "/home/quantised_sa/datasets/multi_objects/tetrominoes" --seed 0 --nums 17 6 --num_workers 4;
      free -m;
";
