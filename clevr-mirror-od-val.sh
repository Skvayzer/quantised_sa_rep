...
singularity exec instance://ml_env9 /bin/bash -c "
      ...
      python3 -u quantised_sa_rep/validation.py --dataset 'clevr-mirror' --task 'clevr mirror trained alter' --alter --from_checkpoint '/home/quantised_sa/sa_autoencoder_end_to_end/clevr-mirror/clevr mirror vanilla 22:00 31.01.2023/60_1.0_clevr mirror vanilla 22:00 31.01.2023_clevr-mirror_od_pretrained.ckpt' --beta 2 --device 'gpu' --max_epochs 2000 --batch_size 16 --train_path "/home/quantised_sa/datasets/clevr-mirror" --seed 29 --nums 8 3 2 2 --num_workers 4;
      free -m;
";
